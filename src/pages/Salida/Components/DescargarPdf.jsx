...
export const DescargarPdf = ({ numeroCompra }) => {
    const descargar = async () => {
        try {
            const respuestaGet = await axios.get(`https://jwmalmcenb-production.up.railway.app/api/valeSalida/descargar/${numeroCompra}`, {
             ...
             link.href = url;
             link.setAttribute('download', `${numeroCompra}-vale_salida.pdf`);

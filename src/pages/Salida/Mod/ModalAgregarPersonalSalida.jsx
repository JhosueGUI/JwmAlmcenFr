...
import { DataPersonal } from "../../Personal/Data/DataPersonal";
import { GetTipoDocumentos } from "../../Personal/Services/GetTipoDocumentos";
import { GetArea } from "../../Personal/Services/GetArea";
import { TbPlus } from "react-icons/tb";


export const ModalAgregarPersonalSalida = ({ pasarSetPersonal }) => {
    //obtner tokrn
    ...
    const agregarCategoria = async () => {
        try {
            ...
            if (token) {
                ...
                const respuestaCategoria = await axios.post("https://zoological-blessing-production.up.railway.app/api/almacen/personal/create", dataPersonal, {
                    headers: {
                ...
                const respuestaCategorias = await axios.get("https://zoological-blessing-production.up.railway.app/api/almacen/personal/get", {
                    headers: {
                        Authorization: `Bearer ${token}`

                    }
                });
                //Adaptar data al momento de seleccionar un personal en base a la estructura del array
                const personalTransformado = respuestaCategorias.data.data.map(personal => ({
                    ...personal,
    ...
    // Manejar cambios en los campos del formulario para solo Area
    ...
    return (
        <>
            ...
            <Toast ref={toast} />
            {/* Contenido */}
            <Button style={{ background: 'rgb(34, 197, 94)', border: '1px solid rgb(34, 197, 94)' }} onClick={crearPersonal}><TbPlus size={23} /></Button>
            <Dialog

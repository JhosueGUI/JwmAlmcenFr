    ...
    const EliminarInventario = async () => {
        try {
            ...
            if (token && pasarInventarioSeleccionado) {
                const respuestaPost = await axios.delete(`https://zoological-blessing-production.up.railway.app/api/almacen/inventario_valorizado/delete/${pasarInventarioSeleccionado.id}`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                const respuestaGet = await axios.get("https://zoological-blessing-production.up.railway.app/api/almacen/inventario_valorizado/get", {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                })

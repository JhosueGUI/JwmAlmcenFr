    ...
    const EditarProveedor = async () => {
        try {
            ...
            if (token && dataProveedor.ruc) {
                ...
                const respuestaPost = await axios.post(`https://zoological-blessing-production.up.railway.app/api/almacen/proveedor/update/${pasarProveedorSeleccionado.id}`, dataProveedor, {
                    headers: {
    ...
    const ConsultarApi = async (e) => {
        ...
        try {
            ...
            if (token) {
                ...
                const respuestaGet = await axios.get(`https://zoological-blessing-production.up.railway.app/api/almacen/proveedor/peticion/get?ruc=${ruc}`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });

...
export const VerPdf = ({ formulario }) => {
    const [showPdfModal, setShowPdfModal] = useState(false);
    const [pdfUrl, setPdfUrl] = useState(null);

    const visualizarPdf = async () => {
        try {
            const response = await axios.get(`https://zoological-blessing-production.up.railway.app/api/orden_compra/descargar/pdf/${formulario}`, {

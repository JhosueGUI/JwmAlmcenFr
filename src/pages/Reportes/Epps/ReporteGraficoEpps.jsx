...
export const ReporteGraficoEpps = () => {
    ...
    const TraerFiltroEpps = async () => {
        try {
            ...
            if (token) {
                const respuestaGet = await axios.get("https://zoological-blessing-production.up.railway.app/api/almacen/reporte/epps/filtro", {
                    params: dataEpps,
                    headers: {
    ...
    const TraerFiltroEppsMes = async () => {
        try {
            const token = obtenerToken();
            if (token) {
                const respuestaGet = await axios.get("https://zoological-blessing-production.up.railway.app/api/almacen/reporte/epps/filtro/mes", {
                    params: { ...dataEpps, año },
                    headers: {
                        Authorization: `Bearer ${token}`
                    }

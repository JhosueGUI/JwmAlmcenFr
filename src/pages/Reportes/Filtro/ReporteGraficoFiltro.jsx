...
export const ReporteGraficoFiltro = () => {
    ...
    const obtenerSubFamilias = async () => {
        try {
            ...
            if (token) {
                const respuestaGet = await axios.get("https://zoological-blessing-production.up.railway.app/api/almacen/sub_familia/sub_familia", {
                    headers: {
    ...
    const TraerFiltro = async () => {
        try {
            ...
            if (token) {
                ...
                const respuestaGet = await axios.get("https://zoological-blessing-production.up.railway.app/api/almacen/reporte/familia/filtro", {
                    params: data,
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
    ...
    const TraerFiltroMes = async () => {
        try {
            ...
            if (token) {
                ...
                const respuestaGet = await axios.get("https://zoological-blessing-production.up.railway.app/api/almacen/reporte/familia/filtro/meses", {
                    params: data,
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
